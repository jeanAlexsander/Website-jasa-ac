...
export default function ServiceList() {
  return (
    <section id="layanan" className="overflow-x-hidden bg-slate-50 py-20">
      <div className="mx-auto min-w-0 max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid min-w-0 gap-8 md:grid-cols-3">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-orange-100 transition-all duration-300 group-hover:bg-orange-700">
