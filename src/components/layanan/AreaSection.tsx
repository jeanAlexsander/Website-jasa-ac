    ...
    <section className="overflow-x-hidden bg-slate-50 py-20">
      <div className="mx-auto max-w-6xl px-6">
        <SectionHeader
          ...
          description="Kami melayani kebutuhan service AC untuk rumah, kantor, ruko, maupun bangunan komersial di berbagai wilayah."
        />

        {/* Cakupan Layanan */}
        <div className="mt-16 grid min-w-0 gap-8 md:grid-cols-2 lg:grid-cols-4">
        ...
        <motion.div
          ...
          className="mt-16 min-w-0 overflow-hidden rounded-3xl border border-orange-100 bg-orange-50 p-10"
        >
          {/* Header Wilayah */}
          <motion.div
          ...
          >
            <MapPinned className="h-8 w-8 shrink-0 text-orange-700" />
